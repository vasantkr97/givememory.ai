...
| `main.py` | `apps/api/src/cli.ts`, React dashboard at `/app` |
| `test.py` | Manual API/UI test flow in `README.md`; automated TS tests are still pending |
...
- Add automated TypeScript tests matching old `test.py` scenarios.
...
- Add deployment-specific hardening such as rate limiting, structured request logging, and a production process manager.
